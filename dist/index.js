...
export function createMcp(searchFn = defaultSearchCommons) {
    const mcp = new McpServer({ name: 'commons-mcp', version: '0.1.0' }, { capabilities: { tools: {} } });
    ...
    // Cast mcp to avoid strict SDK overload type conflicts.
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    mcp.tool('search_commons', 'Search Wikimedia Commons for images by keywords. Returns description and image URL(s).', searchSchema.shape, handler);
